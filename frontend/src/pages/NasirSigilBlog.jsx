          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-16">
              ...
              <div className="bg-amber-50 p-6 rounded-xl mb-6">
                <p className="text-gray-700">
                  👉 <strong>Nasırda siyah noktalar</strong> görüyorsanız endişeleniyor olabilirsiniz. <Link to="/blog/nasirda-siyah-noktalar" className="text-amber-700 hover:text-amber-800 font-semibold underline">Nasırda siyah noktalar neden oluşur?</Link> yazımızda bu konuyu detaylı ele aldık.
                </p>
              </div>
