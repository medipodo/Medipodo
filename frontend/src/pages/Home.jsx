                    ...
                    <div className="p-6">
                      <div className="flex items-center space-x-3 mb-3">
                        ...
                        <Link to={`/hizmet/${service.id}`}>
                          <h3 className="text-xl font-semibold text-blue-950 hover:text-blue-700 transition-colors">
                            {service.title}
                          </h3>
                        </Link>
                      </div>
      ...
      <section className="py-16 bg-gradient-to-b from-white to-blue-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-10">
            <a 
              href="https://www.google.com/maps/place/Medipodo+Podoloji+Ayak+Bak%C4%B1m+Merkezi+Ba%C4%9Fl%C4%B1ca/@39.8969286,32.6455704,17z/data=!4m8!3m7!1s0x14d339993e4d9ba3:0xb51cb666d4e33eb6!8m2!3d39.8969245!4d32.6481453!9m1!1b1!16s%2Fg%2F11sjwqpfq0?entry=ttu&g_ep=EgoyMDI2MDYyNC4wIKXMDSoASAFQAw%3D%3D" 
              target="_blank" 
