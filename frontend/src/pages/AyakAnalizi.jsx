  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Ayak Analizi', url: 'https://medipodo.com/ayak-analizi' }
      ]} />
      ...
      <style>{`
        ...
        /* AyakTakip Promo Section - Quiz Altında */
        .ayaktakip-promo-section {
          margin-top: 40px;
        ...
        .quiz-blog-card:hover {
          transform: translateY(-6px);
          box-shadow: 0 12px 28px rgba(0,0,0,0.12);
        }

        .quiz-blog-card-image {
          width: 100%;
          height: 160px;
          object-fit: cover;
          object-position: center;
      ...
      <div className="ayak-analizi-container">
        <div className="quiz-card">
          {!showResult ? (
            <>
              {/* Bilgilendirici Giriş - Kompakt ve Şık */}
              <div style={{ 
                ...
                <h2 style={{ 
                  ...
                  <span style={{ fontSize: '20px' }}>ℹ️</span> Ayak Sağlığınızı Test Edin
                </h2>
                <p style={{ 
                  color: '#475569', 
                  lineHeight: '1.7', 
                  ...
                  <strong>Ayak Analiz Aracı</strong>, 6 basit soru ile ayak sorunlarınızı değerlendiren interaktif bir testtir. 
                  Batık tırnak, tırnak mantarı, nasır ve çatlak topuk gibi yaygın problemlerin erken tespitine yardımcı olur. 
                  Podolojik değerlendirme alarak profesyonel bakım ihtiyacınızı belirleyebilirsiniz.
                  <span style={{ color: '#94a3b8', fontStyle: 'italic' }}> (Bu araç bilgilendirme amaçlıdır, tıbbi teşhis yerine geçmez.)</span>
                </p>
              </div>
              ...
              {/* AyakTakip App Promotion - Quiz Altında */}
              <div className="ayaktakip-promo-section" data-testid="ayaktakip-quiz-promo">
                <div className="ayaktakip-promo-header">
                  <span className="promo-badge">📱 Mobil Uygulama</span>
                  <h3>AyakTakip Mobil Uygulaması</h3>
                  <p className="promo-subtitle">Ayak sağlığınızı düzenli takip edin</p>
                </div>
                
                <div className="ayaktakip-promo-content">
                  ...
                  <div className="promo-text-content">
                    <p>
                      <strong>AyakTakip</strong>, ayak sağlığını takip etmek isteyen kullanıcılar için geliştirilmiş pratik bir mobil uygulamadır. Günlük gözlemlerinizi kaydedebilir, ayak durumunuzdaki değişimleri düzenli olarak izleyebilirsiniz.
                    </p>
                    
                    <p>
                      Diyabetik ayak takibi ve genel ayak bakımı gözlemleri için uygun olan uygulama ile yeni oluşan durumları fark edebilir, kayıtlarınızı geçmişe dönük inceleyebilirsiniz. Ayrıca oluşturduğunuz kayıtları <strong>PDF rapor</strong> olarak dışa aktarabilirsiniz.
                    </p>
                    
                    <div className="promo-features">
                      <span className="feature-tag">✓ Günlük kayıt</span>
                      <span className="feature-tag">✓ PDF rapor</span>
                      <span className="feature-tag">✓ Değişim takibi</span>
                    </div>
                    ...
                    <a 
                      ...
                      data-testid="ayaktakip-download-quiz"
                    >
              ...
              {/* Son Blog Yazıları - Quiz Altında */}
              <div className="quiz-blog-section" data-testid="quiz-blog-section">
                <h3 className="quiz-blog-title">
                  📚 Ayak Sağlığı Hakkında Faydalı Bilgiler
                </h3>
                <div className="quiz-blog-cards">
                  {blogPosts.slice(0, 6).map((blog, index) => (
                    <Link 
                      key={index} 
                      to={blog.customUrl || `/blog/${blog.slug}`}
                      className="quiz-blog-card"
                    >
                      <img 
                        src={blog.image} 
                        alt={blog.title}
                        className="quiz-blog-card-image"
                      />
                      <div className="quiz-blog-card-content">
                        <div className="quiz-blog-card-title">{blog.title}</div>
                        <div className="quiz-blog-card-excerpt">{blog.excerpt}</div>
                        <div className="quiz-blog-card-meta">
                          <span>📅 {blog.date}</span>
            ...
            <div className="result-container">
              ...
              <div className="result-section" style={{ background: '#f8f9ff', borderLeftColor: '#667eea', padding: '0', overflow: 'hidden' }}>
                <div style={{ padding: '25px' }}>
                  <h3 style={{ marginBottom: '20px', fontSize: '20px' }}>📱 Ayak Sağlığınızı Düzenli Takip Edin</h3>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', alignItems: 'center' }}>
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <p style={{ fontSize: '15px', color: '#555', lineHeight: '1.7', marginBottom: '15px' }}>
                        <strong style={{ color: '#667eea' }}>AyakTakip</strong>, ayak sağlığını takip etmek isteyen kullanıcılar için geliştirilmiş pratik bir mobil uygulamadır. Günlük gözlemlerinizi kaydedebilir, ayak durumunuzdaki değişimleri düzenli olarak izleyebilirsiniz.
                      </p>
                      
                      <p style={{ fontSize: '14px', color: '#666', lineHeight: '1.6', marginBottom: '15px' }}>
                        Diyabetik ayak takibi ve genel ayak bakımı gözlemleri için uygun olan uygulama ile yeni oluşan durumları fark edebilir, kayıtlarınızı geçmişe dönük inceleyebilirsiniz. Ayrıca oluşturduğunuz kayıtları <strong style={{ color: '#667eea' }}>PDF rapor</strong> olarak dışa aktarabilirsiniz.
                      </p>
