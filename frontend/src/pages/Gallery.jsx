  ...
  return (
    <>
      ...
      <BreadcrumbSchema items={[
        ...
        { name: 'Galeri', url: 'https://medipodo.com/galeri' }
      ]} />
      ...
      {/* Bilgilendirici Giriş Metni */}
      <section className="py-12 bg-white border-b">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-blue-50 rounded-xl p-8 border border-blue-100">
              <h2 className="text-2xl font-bold text-blue-950 mb-4">Podolojik Bakım Sonuçlarımız</h2>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p>
                  <strong>Medipodo Galeri</strong> sayfasında, merkezimizde gerçekleştirilen podolojik bakım uygulamalarının 
                  görsel sonuçlarını inceleyebilirsiniz. Her vaka, danışanlarımızın izni dahilinde ve gizlilik ilkelerine 
                  uygun şekilde paylaşılmaktadır. Bu görseller, batık tırnak, tırnak mantarı, nasır, çatlak topuk ve 
                  medikal ayak bakımı gibi yaygın ayak sorunlarında elde edilen sonuçları yansıtmaktadır.
                </p>
                <p>
                  Podolojik bakım, cerrahi müdahale gerektirmeyen, steril ortamda ve bilimsel yöntemlerle uygulanan 
                  profesyonel bir sağlık hizmetidir. Galerimizde yer alan her görsel, uzman podologlarımızın titiz 
                  çalışmasının ve modern ekipmanlarımızın bir yansımasıdır. Ortoniksi (tırnak teli) uygulamaları, 
                  tırnak restorasyonu, hiperkeratoz temizliği ve diyabetik ayak bakımı gibi farklı uygulama örneklerini 
                  bu sayfada bulabilirsiniz.
                </p>
                <p>
                  <em>Not: Görseller bilgilendirme amaçlıdır. Her vakanın kendine özgü koşulları olduğundan, 
                  sonuçlar kişiden kişiye farklılık gösterebilir. Detaylı değerlendirme için randevu almanızı öneririz.</em>
                </p>
              </div>
            </div>
          </div>
