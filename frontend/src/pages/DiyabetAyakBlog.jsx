        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-12">
              ...
              <div className="my-8">
                <img 
                  src="/blog-images/diyabet/1.webp" 
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <img 
                  src="/blog-images/diyabet/2.webp" 
                  alt="Diyabetik nöropati" 
                  className="w-full rounded-xl shadow-lg"
                />
                <img 
                  src="/blog-images/diyabet/3.webp" 
                  alt="Ayak muayenesi" 
                  className="w-full rounded-xl shadow-lg"
                />
              </div>
              ...
              <div className="my-8">
                <img 
                  src="/blog-images/diyabet/4.webp" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <img 
                  src="/blog-images/diyabet/5.webp" 
                  alt="Damar sağlığı" 
                  className="w-full rounded-xl shadow-lg"
                />
                <img 
                  src="/blog-images/diyabet/6.webp" 
            ...
            <section className="mb-12">
              ...
              <div className="my-8">
                <img 
                  src="/blog-images/diyabet/7.webp" 
              ...
              <div className="my-8">
                <img 
                  src="/blog-images/diyabet/8.webp" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <img 
                  src="/blog-images/diyabet/10.webp" 
                  alt="Doğru ayakkabı seçimi" 
                  className="w-full rounded-xl shadow-lg"
                />
                <img 
                  src="/blog-images/diyabet/11.webp" 
