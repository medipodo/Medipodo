  ...
  const values = [
    {
      ...
      description:
        'Her danışan bizim için ayrı bir hikâyedir. Hizmetimizi kişiye özel, özenli ve kapsayıcı bir yaklaşımla sunarız.'
    },
    {
      icon: Award,
      title: 'Mükemmellik',
      description:
        'Her detayda kaliteyi önemser, en yüksek hizmet standartlarını sunmayı taahhüt ederiz.'
    },
    {
      icon: Target,
      title: 'Uzmanlık',
      description:
        'Sürekli eğitim ve gelişimle, en güncel uygulamaları danışanlarımızla buluştururuz.'
    },
    {
      icon: Users,
      title: 'Şeffaflık',
      description:
        'Açık, net ve güven veren iletişim kurarak danışanlarımızla güçlü bir bağ oluştururuz.'
    }
  ];
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                podoloji alanında uzmanlaşmış, danışan odaklı bir uygulama merkezidir.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                <div className="order-2 lg:order-1">
                  ...
                  <div className="space-y-4 text-gray-600 leading-relaxed">
                    ...
                    <p>
                      Steril ve özenli bir ortamda; yalnızca tedavi değil, aynı zamanda güven ve rahatlık
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Hizmet anlayışımızı ve danışan ilişkilerimizi şekillendiren temel ilkelerimiz
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card className="border-2 border-blue-200">
                  <CardContent className="p-8">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      İnsanların ayak sağlığını iyileştirerek yaşam kalitelerini artırmak; bunu yaparken
                      her bireye özel, güvenilir ve sürdürülebilir çözümler sunmak.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-2 border-blue-200">
                  <CardContent className="p-8">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Türkiye&apos;de podoloji alanında güven duyulan, referans gösterilen ve standartları
                      belirleyen öncü bir merkez olmak.
                    </p>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-blue-100">Mutlu Danışan</div>
              </div>
              <div className="text-center">
