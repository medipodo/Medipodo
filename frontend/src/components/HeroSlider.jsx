...
const HeroSlider = () => {
  ...
  const desktopSlides = [
    {
      ...
      description: 'Batık tırnak, tırnak mantarı ve ayak bakımı konusunda profesyonel ekibimizle yanınızdayız',
      cta: 'Randevu Alın',
      ctaLink: '/iletisim'
    },
    {
  ...
  ctaLink: '/ayak-analizi'
        },
    {
      ...
      subtitle: 'Konfor Odaklı Profesyonel Yaklaşım',
      description: 'Ortoniksi uygulaması ile batık tırnak şikayetlerinin azaltılmasına yardımcı olabilecek profesyonel bakım',
      cta: 'Detaylı Bilgi',
  ...
  const mobileSlides = [
    ...
    },
    {
      ...
      description: 'Alanında deneyimli podologlarımız ile profesyonel bakım ve değerlendirme hizmeti',
      cta: 'Ekibimiz',
      ctaLink: '/ekip'
    }
  ];
