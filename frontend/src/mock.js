...
export const siteInfo = {
  ...
  disclaimer: 'Bu sitedeki bilgiler bilgilendirme amaçlıdır ve tıbbi teşhis yerine geçmez.'
};
...
export const services = [
  {
    ...
    shortDesc: 'Batık tırnaklarda basıncı azaltmaya yönelik podolojik bakım uygulamaları',
    fullDesc: 'Batık tırnak, tırnağın kenarlarının cilde batması sonucu oluşan ağrılı bir durumdur. Profesyonel podolojik yaklaşım ile batık tırnakta oluşan baskının azaltılmasına yönelik bakım uygulamaları yapılır.',
    icon: 'Scissors',
    image: '/images/services/Batik-Tirnak-tedavisi.jpg',
    benefits: [
      'Ağrısız ortoniksi yöntemleri',
      'Hızlı ve rahatlatıcı çözümler',
    ...
    detailedContent: {
      ...
      symptoms: {
        ...
        note: 'Bu belirtiler görüldüğünde podolojik değerlendirme önerilir.'
      },
      treatment: {
        title: 'Medipodo\'da Batık Tırnak Uygulamaları Nasıl Yapılır?',
        intro: 'Başarılı bir batık tırnak uygulamalarının temelinde doğru teknik, steril çalışma ve kişiye özel yaklaşım vardır. Medipodo\'da uyguladığımız yöntem:',
        steps: [
          {
            number: 1,
      ...
      risks: {
        title: 'Batık Tırnak İhmal Edilirse Ne Olabilir?',
        intro: 'İhmal edilen batık tırnak zamanla:',
        consequences: [
          'Kronik ağrıya',
          'İleri enfeksiyona',
        ...
        note: 'Bu nedenle erken değerlendirme ve bakım önerilir.'
      },
      prevention: {
      ...
      whyMedipodo: {
        ...
        reasons: [
          ...
          'Tam steril ortam',
          'Ağrısız batık tırnak bakım uygulamaları',
        ...
        note: 'Medipodo olarak amacımız geçici değil, uzun süreli ve konforlu bir çözüm sunmaktır.'
      },
      images: [
  ...
  },
  {
    ...
    shortDesc: 'Tırnak mantarında podolojik bakım ve düzenli takip',
    fullDesc: 'Tırnak mantarı, tırnak yapısını bozan ve estetik sorunlara yol açan fungal bir enfeksiyondur. Podolojik bakım uygulamaları ile tırnak sağlığının desteklenmesi hedeflenir. Uzman podologlarımız, kişiye özel bakım planları hazırlayarak, tırnaklarınızın sağlığına kavuşmasını sağlar. Bakım sürecinde düzenli takip ile sürecin desteklenmesi hedeflenir.',
    icon: 'ShieldCheck',
    image: '/images/services/Tirnak-Mantari.jpg',
    benefits: [
      'Modern Uygulama protokolleri',
      'Hızlı iyileşme süreci',
      'Tekrarlama riskini azaltma',
      'Kişiye özel bakım planı'
    ],
    process: [
      'Podolojik değerlendirme',
      'Uygulama planlaması',
    ...
    detailedContent: {
      ...
      treatment: {
        title: 'Podolojik Tırnak Mantarı Bakımı – Medipodo Yaklaşımı',
        ...
        steps: [
          ...
          },
          {
            ...
            description: 'Tırnak mantarı uygulamaları ve gidişatı genellikle 2–6 ay sürer. Düzenli kontrollere gelmek uygulamaların başarısı için kritik önemdedir.'
          }
        ]
      },
      risks: {
        title: 'Tırnak Mantarı İhmal Edilirse Ne Olur?',
        consequences: [
        ...
        note: 'Bu nedenle erken başvuru başarının temel anahtarıdır.'
      },
      prevention: {
      ...
      whyMedipodo: {
        ...
        reasons: [
          ...
          'Mantarın evrelerine uygun kişiye özel bakım planı',
  ...
  },
  {
    ...
    shortDesc: 'Çatlak topuklar için profesyonel bakım',
    ...
    detailedContent: {
      ...
      treatment: {
        ...
        steps: [
          ...
          },
          {
            ...
            description: 'İşlemlerin tekrarlamaması için doğru nemlendirme, ayakkabı seçimi ve günlük bakım adımları detaylı olarak anlatılır.'
          }
        ]
      },
      benefits: {
        ...
        list: [
          ...
          'Çatlak görünümünün azalmasına ve cilt konforunun artmasına yardımcı olur',
      ...
      whyMedipodo: {
        ...
        reasons: [
          ...
          'Etkili bakım planına odaklanan yaklaşım',
          'Ankara / Bağlıca\'da kolay ulaşım'
        ],
        note: 'Topuk çatlakları, doğru bakım yapılmadıkça sürekli tekrar eden bir problemdir. Medipodo olarak amacımız geçici bir "güzellik" değil, uzun süreli konfor sağlamaktır.'
      },
      images: [
  ...
  },
  {
    ...
    shortDesc: 'Ağrılı nasırların profesyonel bakımı',
  ...
  },
  {
    ...
    fullDesc: 'Ayaklarınızın sağlığı için kapsamlı bakım programı. Temizlikten bakıma, tırnak kesiminden cilt bakımına kadar tüm ihtiyaçlarınız için buradayız. Steril koşullarda, profesyonel ürünler kullanarak gerçekleştirdiğimiz medikal ayak bakımı, hem daha detaylı hem de rahatlat',
    icon: 'Heart',
  ...
  },
  {
    ...
    process: [
      ...
      'Tırnak kesimi, mantar bakımı, nasır temizliği',
...
export const blogPosts = enrichedBlogPosts.length > 0 ? enrichedBlogPosts : [
  {
    ...
    excerpt: 'B/S Bant uygulaması nedir, nasıl çalışır? Batık tırnak uygulamalarında tırnak teline alternatif, acısız ve estetik çözüm. Ankara Medipodo\'da uygulanıyor.',
    content: 'B/S Bant Uygulaması Nedir?',
    author: 'Medipodo Podoloji Ekibi',
    date: '2025-12-16',
    readTime: '12 dakika',
    image: '/images/blog/bs-bant/bs-bant.jpg',
    tags: ['B/S Bant', 'Batık Tırnak', 'Podoloji', 'Tırnak Teli', 'Podolog']
  },
  {
    id: 'tirnakbatmasi',
    title: 'Tırnak Batması Neden Olur? En Sık Yapılan Hatalar ve Doğru Çözümler',
    slug: 'tirnakbatmasi',
    excerpt: 'Tırnak batmasının nedenleri, evde yapılan hatalar, podolojik yöntemler ve yöntemler. Medipodo ile tanışın.',
    ...
    tags: ['Tırnak Batması', 'Podoloji', 'Podolog']
  },
  {
...
Herhangi bir ağrı, şişlik, renk değişikliği veya yara durumunda uzman bir podologa başvurun. Erken farkındalık uygulamaları kolaylaştırır.
...
Batık tırnak, tırnağın kenarlarının yanındaki yumuşak dokuya batması sonucu oluşan ağrılı bir durumdur. Bu yaygın problemi anlamak ve önlemek için kapsamlı bilgiler sunuyoruz.`,
  ...
  },
  {
    ...
    title: 'Tırnak Mantarı: Modern Bakım Yöntemleri',
    slug: 'tirnak-mantari-tedavisi',
    excerpt: 'Tırnak mantarı bakımlarında güncel yaklaşımlar, bakım süreçleri ve kalıcı çözüm yöntemlerini öğrenin.',
    content: `# Tırnak Mantarı: Modern Bakım Yöntemleri

Tırnak mantarı, dünya çapında milyonlarca insanı etkileyen yaygın bir sağlık problemidir. Modern podoloji yöntemleri ile bu rahatsızlıktan tamamen kurtulmak mümkün.`,
    author: 'Dr. Zeynep Arslan',
    date: '2024-01-25',
    readTime: '8 dakika',
    image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=800&h=400&fit=crop',
    tags: ['Tırnak Mantarı', 'Onikomikoz', 'Modern Podoloji']
  },
...
export const products = [
  ...
  },
  {
    ...
    benefits: [
      'Çatlak topuklara onarıcı bakım',
    ...
    professionalUse: 'Podoloji uygulamalarından sonra, temizlenmiş bölgeye ince bir tabaka halinde uygulayarak tedavi sonrası bakımı destekler.',
...
export const faqData = [
  {
    ...
    answer: 'Podoloji, ayak ve tırnak sağlığının korunması, bakımı ve sorunlarının önlenmesiyle ilgilenen sağlık bilimidir. Podologlar, cerrahi olmayan medikal yöntemlerle batık tırnak, tırnak mantarı, nasır, çatlak topuk, siğil ve diyabetik ayak bakımı gibi sorunlara uzun süreli bakım çözümleri sunar.',
    category: 'Genel'
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: 'Batık Tırnak İşlemi Ne Kadar Sürer ve Ağrılı Bir İşlem midir?',
    answer: 'Batık tırnak uygulamaları (tel sistemi), sorunun şiddetine bağlı olarak 3 ila 9 ay sürebilir. İşlem sırasında lokal anestezi uygulanmadığı için hafif bir hassasiyet hissedilebilir, ancak ağrılı bir işlem değildir. Medipodo\'da uygulanan modern podolojik yöntemler, tırnağın doğal büyüme yönünü düzelterek kalıcı çözüm sağlar.',
    category: 'Tedavi'
  },
  {
    id: 4,
    question: 'Tırnak Mantarı Evde Uygulanan Doğal Yöntemlerle Geçer mi?',
    answer: 'Tırnak mantarı (Onikomikoz) inatçı bir enfeksiyondur ve sirke, karbonat gibi doğal yöntemler genellikle yetersiz kalır. Öncelikle tırnağın küretajı, lazer veya özel bakım ürünleri (Pedizone) ile kombine edilen podolojik bakım ve takip önerilir.',
    category: 'Tedavi',
  ...
  },
  {
    ...
    answer: 'Nasır, sürtünme ve baskı sonucu oluşan ölü deri kalınlaşmasıdır. Siğil ise HPV virüsünün neden olduğu bulaşıcı bir lezyondur. Yanlış teşhis ve bilinçsiz asitli ilaç kullanımı, siğilin yayılmasına veya nasırın derinleşmesine neden olabilir. Doğru değerlendirme ve uygun bakım planı için podolojik görüş alınması önerilir.',
    category: 'Tedavi',
  ...
  },
  {
    ...
    answer: 'Pedikür, estetik ve kozmetik bir işlemdir. Medikal ayak bakımı ise podologlar tarafından, steril aletler ve bilimsel yöntemlerle, tırnak ve cilt sorunlarını (nasır, mantar, kalınlaşmış tırnak) bakım ve değerlendirmeye yönelik uygulanan bir sağlık hizmetidir. Medikal bakımda kesici aletler kullanılmaz ve enfeksiyon riski sıfırdır.',
    category: 'Genel'
  },
  {
    id: 8,
  ...
  {
    id: 15,
    question: 'Tırnak Mantarı Sürecinde Lazer Kullanımı Ne Kadar Etkilidir?',
  ...
  {
    id: 16,
    question: 'Düz Tabanlık (Pes Planus) Yetişkinlerde Nasıl Yönetilir?',
  ...
  {
    id: 18,
    question: 'Çocuklarda Tırnak Batması Neden Olur ve Nasıl Yönetilir?',
